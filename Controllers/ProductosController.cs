...
namespace Colmado2.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,nombre,proveedor,peso,precio")] Productos productos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,proveedor,peso,precio")] Productos productos)
        {
            if (ModelState.IsValid)
            {
